...
# Create routers
forecast_router = APIRouter(prefix="/forecast", tags=["Cost Forecast"])
alerts_router = APIRouter(prefix="/alerts", tags=["Early Warning"])
outlook_router = APIRouter(prefix="/outlook", tags=["Local Production"])
market_router = APIRouter(prefix="/market", tags=["Competitive Health"])
strategy_router = APIRouter(prefix="/strategy", tags=["Strategic Summary"])


# ==========================================
# 1. Cost Forecast API
# ==========================================
@forecast_router.post("/cost", response_model=CostForecastResponse)
...
# 2. Early Warning API
# ==========================================
@alerts_router.post("/early-warning", response_model=EarlyWarningResponse)
...
# ==========================================
@outlook_router.post("/local-production", response_model=LocalProductionResponse)
...
# ==========================================
@market_router.post("/competitive-health", response_model=CompetitiveHealthResponse)
...
# ==========================================
@strategy_router.post("/summary", response_model=StrategicSummaryResponse)
